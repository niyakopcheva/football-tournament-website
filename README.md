...
2. Uses the `TeamFormation` component to show team formations.  
   ...
   ![image](https://github.com/user-attachments/assets/cf9cf2b7-b55d-4a87-8368-afcef1a51b21)

### 4. Team Details
1. Based on the `id` prop from the URL, fetches the team's players.
2. Displays player numbers, names, and positions.
   
   ![image](https://github.com/user-attachments/assets/9f1f6595-c889-4462-9d9a-771187c26ba7)
